<form x-on:submit.prevent="sendDataProduct">
    ...
    <div class="flex items-center space-x-4 pt-4 md:pt-6">
        <button type="submit" class="inline-flex items-center  text-white bg-blue-600 hover:bg-blue-700 rounded-lg box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
            Simpan
        </button>
        <button x-on:click="btnCancelCreate" type="button" class="text-body bg-gray-400 rounded-lg box-border border border-default-medium hover:bg-gray-500 hover:text-heading focus:ring-4 focus:ring-neutral-tertiary shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">Cancel</button>
    </div>
</form>